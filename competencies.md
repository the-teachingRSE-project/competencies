...
Namely, that there are different types that also affect modifications they might want to publish, e.g. as a product of their thesis. 
At least they should learn whom to ask regarding licensing issues (\gls{SP}).
