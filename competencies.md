...
| \gls{MOD}        | Should have a basic grasp of the part of the software they are responsible for in order to use basic tools such as a debugger.                      | Should understand the characteristics of large parts of the codebase considering a variety of the metrics.                            | Should have an intricate understanding of the software project and its aims in order to effectively steer it.                                                                        |
