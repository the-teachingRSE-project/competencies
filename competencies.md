...
This also means that students as well as researchers need to be given time to aquire those skills, e.g., to be able to attend training in RSE-relevant topics as part of their regular work or study.
