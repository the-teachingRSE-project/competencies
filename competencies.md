...
The INTERSECT RSE Training project [@INTERSECTOnlineResources; @Carver2020] also provides training materials and organizes training workshops and bootcamps in the USA, funded by the NSF.
...
organizes online events, provides training material under BSSW.io [@BSSW]
...
Using that, an RSE should be able to make predictions about the behaviour of a program.
...
While everybody contributed to the discussion formulating and refining the ideas, and to collaboratively writing and/or reviewing and editing the entirety of the script, some parts merit special mention.
