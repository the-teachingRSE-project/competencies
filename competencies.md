...
than in other (e.g., software engineering economics).
...
their compatibility, and the ramifications for re-using and composing programs.
...
| \gls{USERS}      | Should be able to communicate with SEs and researchers of the project.                                                               | Same as junior RSE, and be able to interpret the feedback.                                                                            | Same as senior, and should also be able to effectively take feedback into account when steering the project.                                                                        |
...
A deep knowledge of web development skills is a required additional skill for this RSE.
