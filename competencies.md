...
The last two decades saw the limits in the attainable miniaturisation of transistor technology approaching, and top chip clock frequency mostly settled. [@Sutter2005]
...
In this scenario, RSEs have a responsibility, for instance when choosing computationally adequate approaches (e.g. recognising where a well-proved statistical method may do well instead of a power-hungry AI model, or configuring a test pipeline to minimise redundancy), and embracing data frugality measures (e.g. recognising sufficient resolutions when sampling data for processing or storage),
